...
const MIN_RISK_PTS       = parseFloat(process.env.MIN_RISK_PTS       || '0.30'); // QQQ points (~$0.30 min risk)
const MAX_1M_BARS        = parseInt(process.env.MAX_1M_BARS          || '90');
const SL_BUFFER          = parseFloat(process.env.SL_BUFFER          || '0.50'); // QQQ points beyond sweep wick
